...
- die einbettung von sl in scala konnte erweitert werden

- das der sl compiler in scala geschrieben wurde machte einfacher war aber nicht unbedingt nötig

- insbesondere das annotieren von funktionen ist eine eigenheit

- für den produktiven einsatz ist noch einiges zu tun

- besonders bessere verwendung von bereits existierenden js-bibliotheken

- möglicherweise lieber anderen ansatz bevorzugen <-
