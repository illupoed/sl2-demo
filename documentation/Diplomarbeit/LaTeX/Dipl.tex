...
Die finale Version des Quelltext im Rahmen der Diplomarbeit wurde mit dem git-Tag \lstinline!v0.1! markiert. Man kann sie optional folgendermaßen auschecken:
\begin{lstlisting}
cd <project path path>
